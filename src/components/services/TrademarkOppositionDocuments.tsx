...
import { TRADEMARK_OPPOSITION_DOCUMENTS } from "@/lib/services-constants";
import { FileText, User, Shield, AlertCircle } from "lucide-react";

const TrademarkOppositionDocuments = () => {
  const getIcon = (index: number) => {
    const icons = [User, FileText, Shield, AlertCircle];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-6 md:mb-8 lg:mb-12">
            ...
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-3">
              {TRADEMARK_OPPOSITION_DOCUMENTS.title}
            </h2>
            <p className="text-base text-gray-600 max-w-2xl mx-auto">
              Ensure you have all the necessary documents ready for a smooth trademark opposition process.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {TRADEMARK_OPPOSITION_DOCUMENTS.categories.map((category, index) => (
...
export default TrademarkOppositionDocuments;
