        ...
        <div className="max-w-7xl mx-auto">
                    ...
                    <tr className="bg-gray-100">
                      ...
                      {entityTypes.map((entity, index) => (
                        <th key={index} className={`text-center p-3 md:p-4 font-bold text-gray-900 min-w-[150px] ${
                          index === 1 ? 'bg-brand-primary text-white' : ''
                        }`}>
                          {entity}
                        </th>
                      ))}
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 bg-white p-4 rounded-lg shadow-sm">
              <span className="font-semibold text-brand-primary">Note:</span> One Person Company offers the perfect solution for 
              solo entrepreneurs with limited liability protection and moderate compliance requirements.
            </p>
          </div>
        </div>
      </div>
